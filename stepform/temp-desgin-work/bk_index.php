					...
					<div class="step-10 d-none">
						<div class="row">
							...
							<div class="col-sm-7 center-block col-lg-7">
								<div class="form-group has-error">
									<input id="address-postcode" type="text" pattern="^[A-Za-z]{1,2}[0-9][0-9A-Za-z]?\s?[0-9][A-Za-z]{2}$" class="form-control js-postcode custom-inputs custom-placeholder" data-error="Please enter a valid UK postcode" required="" placeholder="Type postcode">
									<span class="help-block with-errors d-none"><ul class="list-unstyled mt-2"><li>Please enter a valid UK postcode</li></ul></span>
									<div class="d-flex justify-content-center"><button class="btn btn-block btn-postcode postcode-lookup mt-3">Search for address</button></div>
								</div>
								
								<div class="select-address-field d-none">
									<div class="form-group has-error mt-4">
										<select class="form-control city-select" style="">
