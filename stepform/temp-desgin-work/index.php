...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="https://i3.deals/dealer/dashboard/build/css/intlTelInput.css">
		<style>
		.hide {
			display: none;
		}
		#inputTel:not(:placeholder-shown) {
			padding-top: 0;
			padding-bottom: 0;
		}
		...
		input[type=tel]::placeholder {
			...
			color: #a39c99;
			font-weight: 600;
			font-style:  -apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,"Helvetica Neue",Arial,sans-serif,"Apple Color Emoji","Segoe UI Emoji","Segoe UI Symbol" !important;
		}
	...
	<body>
		<div class="container mt-5">
			<div class="form-holder">
				<form id="add_applicant"  method="POST" action="function.php">
				...
				<input type="hidden" name="jobtitle_final_value" id="jobtitle_final_value" value="">
					...
					<div class="step-1 ">
						<div class="row" data-name="monthly-budget-step">
							...
							<div class="col-lg-4 button-list col-md-6 col-sm-12" data-value="Under £150 / month">
					...
					<div class="step-10 d-none">
						<div class="row">
							...
							<span class="help-block with-errors d-none residential-status-error" style="color:#ff0000"><ul class="list-unstyled"><li>We require at least 3 years worth of Residential history. Please select your previous Residential status.</li></ul></span>
								<p class="qus-postcode">What is your postcode?</p>
								<div class="confirm-address d-none" id="confirm-address"></div>
							</div>
						...
						<div class="row justify-content-center" >
							<div class="col-md-4 next-step" id="p-next"  disabled="disabled"  step-button-value="search-postcode-step">
								<a href="javascript:void(0)" class="btn btn-block btn-next btn-default js-btn-next">Next Step</a>
							</div>
						</div>
					</div>
					...
					<div class="step-11 d-none">
						<div class="row" data-name="residential-step">
							<div class="col-md-12 step-form-content text-center">
								<h3>Address Details</h3>
								<p>What is your residential status?</p>
							</div>
							<div class="col-lg-4 col-md-6 col-sm-12  button-list" data-value="Homeowner">
								<div class="button-list-holder residential-step add-class-active">Homeowner</div>
							</div>
							<div class="col-lg-4 col-md-6 col-sm-12  button-list" data-value="Tenant - Private">
								<div class="button-list-holder residential-step">Tenant - Private</div>
							</div>
							<div class="col-lg-4 col-md-6 col-sm-12  button-list" data-value="Tenant - Housing">
								<div class="button-list-holder residential-step">Tenant - Housing</div>
							</div>
							<div class="col-lg-4  col-md-6 col-sm-12 button-list" data-value="Tenant - Council">
								<div class="button-list-holder residential-step">Tenant - Council</div>
							</div>
							<div class="col-lg-4 col-md-6 col-sm-12  button-list" data-value="Living With Family">
								<div class="button-list-holder residential-step">Living with family</div>
							</div>
							<div class="col-lg-4 col-md-6 col-sm-12  button-list" data-value="Military Accommodation">
								<div class="button-list-holder residential-step">Military Accommodation</div>
							</div>
							<div class="col-lg-4  col-md-6 col-sm-12 button-list" data-value="Work Accommodation">
								<div class="button-list-holder residential-step">Work Accommodation</div>
							</div>
							<div class="col-lg-4 col-md-6 col-sm-12  button-list" data-value="Student Accommodation">
								<div class="button-list-holder residential-step">Student Accommodation</div>
							</div>
							<div class="col-lg-4 col-md-6 col-sm-12  button-list" data-value="Other">
								<div class="button-list-holder residential-step">Other</div>
							</div>
							
						</div>
						<div class="row justify-content-center">
							<div class="col-md-4 next-step" step-button-value="residential-status-step">
								<a href="javascript:void(0)" class="btn btn-block btn-next btn-default js-btn-next">Next Step</a>
							</div>
						</div>
					</div>
					...
					<div class="step-12  d-none">
						<div class="row">
							...
							<div class="center-block col-sm-9">
								<div class="form-group">
									<div class="col-xs-6 no-padding">
										<input type="number" class="form-control no-radius-right custom-inputs residential-years" id="residential-years" name="residential-years"  autocomplete="residential-years" placeholder="Enter Years" min="0" max="99" original-name="residential-years">
									</div>
									<div class="col-xs-6 no-padding">
										<label for="residential-years" class="form-label form-control label-button no-radius-left ">Years</label>
									</div>
									<span class="help-block with-errors d-none res-years-error"><ul class="list-unstyled "><li>Please enter Years of residential</li></ul></span>
								</div>
								<div class="form-group has-error">
									<div class="col-xs-6 no-padding">
										<input type="number" class="form-control no-radius-right custom-inputs residential-months" id="residential-months" name="residential-months" data-error="Please enter months of residential" required="" autocomplete="residential-months" placeholder="Enter Months" min="1" max="11" original-name="residential-months">
									</div>
									<div class="col-xs-6 no-padding">
										<label for="residential-months" class="form-label form-control label-button no-radius-left">Months</label>
									</div>
										<span class="help-block with-errors d-none res-months-error"><ul class="list-unstyled "><li>Please enter Months of residential</li></ul></span>
								</div>
							</div>
						</div>
						<div class="row justify-content-center">
							<div class="col-md-4 next-step" step-button-value="residential-time-step">
								<a href="javascript:void(0)" class="btn btn-block btn-next btn-default js-btn-next">Next Step</a>
							</div>
						</div>
					</div>
					...
					<div class="step-13 d-none">
						<div class="row"  data-name="almost-done-step">
							<div class="col-md-12 step-form-content text-center">
								<h3>Almost done</h3>
								<p>Let us know who you are</p>
							</div>
							<div class="col-lg-3 col-md-6 col-sm-6 col-12 button-list" data-value="Mr">
								<div class="button-list-holder almost-done-step add-class-active">Mr</div>
							</div>
							<div class="col-lg-3 col-md-6 col-sm-6 col-12 button-list" data-value="Mrs">
								<div class="button-list-holder almost-done-step">Mrs</div>
							</div>
							<div class="col-lg-3 col-md-6 col-sm-6 col-12 button-list" data-value="Miss">
								<div class="button-list-holder almost-done-step">Miss</div>
							</div>
							<div class="col-lg-3 col-md-6 col-sm-6 col-12 button-list" data-value="Ms">
								<div class="button-list-holder almost-done-step">Ms</div>
							</div>	
							<div class="col-lg-6  almost-done">
								...
								<span class="help-block with-errors d-none  Forename-error" style="color:#ff0000""><ul class="list-unstyled mt-2"><li>Please enter your first name  (min 2 characters)</li></ul></span>
							</div>	
							<div class="col-lg-6  almost-done">
								...
								<span class="help-block with-errors d-none  Surname-error" style="color:#ff0000""><ul class="list-unstyled mt-2"><li>Please enter your surname (min 2 characters)</li></ul></span>
							</div>		
						</div>
						<div class="row justify-content-center">
							<div class="col-md-4 next-step" step-button-value="almost-done-step">
								<a href="javascript:void(0)" class="btn btn-block btn-next btn-default js-btn-next">Next Step</a>
							</div>
						</div>
					</div>
					...
					<div class="step-14 d-none">
						<div class="row">
							...
							<div class="col-lg-6  almost-done px-3">
								<label for="Forename" class="form-label font-weight-bold"><span data-jointapp-text="Their "></span>Mobile Number</label>
								<input type="hidden" id="country" name="country" value="+44" />
								<input type="tel" class="form-control custom-inputs custom-placeholder" placeholder="Mobile number here" id="phone" name="Mobile" data-error="Must start 07 and be 11 characters long" autocomplete="tel" required="" original-name="mobile">
								
								<span id="valid-msg" class="hide">✓ Valid</span>
								<span id="error-msg" class="hide"></span>
                                <span class="help-block with-errors d-none  phone-error" style="color:#ff0000""><ul class="list-unstyled mt-2"><li>Please enter Mobile Number Here</li></ul></span>
							</div>	
							<div class="col-lg-6  almost-done px-3">
							 ...
							 <span class="help-block with-errors d-none  Email-error" style="color:#ff0000""><ul class="list-unstyled mt-2"><li>Please enter Email Here</li></ul></span>
        ...
        <div class="col-md-12">
            ...
            <input type="hidden" name="TermsAndConditions" id="TermsAndConditions" value="on" original-name="TermsAndConditions">
        </div>
<div class="col-md-12">
            <p class="sh-marketing-text mt-2">
                ...
                <span class="">
                    <label for="sh-marketing" class="label-sh-marketing">
						...
						<div class="row justify-content-center">
							<div class="col-md-4 next-step" step-button-value="all-done-step">
								<a href="javascript:void(0)" class="btn btn-block btn-next btn-default js-btn-next">Next Step</a>
							</div>
						</div>
					</div>
...
<script src="https://i3.deals/dealer/dashboard/build/js/intlTelInput.js"></script>
<script src="https://getaddress.io/Scripts/jquery-3.3.1.js"></script>
<script src="https://www.motor.market/temp-desgin-work/js/jquery.getAddress-4.0.0.min.js"></script>
...
<script>
function myFunction() {
	var finadd =$("#getaddress_dropdown :selected").text();
 alert(finadd);
		 $(".custom-address").addClass("d-none");
            ...
            $(".confirm-address").removeClass("d-none");
             $('#confirm-address').val(finadd);
}
</script>
<script>
$(document).ready(function() {
$('select[class="getaddress_dropdown_class"]').change(function(){

   var finadd = $(this).text();
        alert(finadd);
		 $(".custom-address").addClass("d-none");
		    $(".qus-postcode").addClass("d-none");
		    $(".mannual-postcode").addClass("d-none");
...
var input = document.querySelector("#phone"),
	...
	var iti = window.intlTelInput(input, {
	  initialCountry: "gb",
	  utilsScript: "https://i3.deals/dealer/dashboard/build/js/utils.js"
	});
...
else if (div_name == 'residential-step') {
			    var f_id=$("input:hidden").attr("id");
           
			
			 alert(f_id);
			 if (typeof f_id === "undefined") {
     $('#add_applicant').prepend('<input type="hidden"  id="Residential_Status" name="Residential_Status[]" value="'+div_value+'" />');
}else{
	
			 if(f_id=='Residential_Status'){
				  $('#Residential_Status').val(div_value);
			 }
			 else{
				 $('#add_applicant').prepend('<input type="hidden" id="Residential_Status" name="Residential_Status[]" value="'+div_value+'" />');
			 }
...
else if (div_name == 'almost-done-step') {
			    var f_id=$("input:hidden").attr("id");
           
			
			 alert(f_id);
			 if (typeof f_id === "undefined") {
     $('#add_applicant').prepend('<input type="hidden"  id="Final_title" name="Final_title" value="'+div_value+'" />');
}else{
	
			 if(f_id=='Final_title'){
				  $('#Final_title').val(div_value);
			 }
			 else{
				 $('#add_applicant').prepend('<input type="hidden" id="Final_title" name="Final_title" value="'+div_value+'" />');
			 }
                ...
                function underAgeValidate(birthday) {
                    ...
                    if (myAge < 18) {
                        ...
                        $(".step-6").removeClass("d-none");
                        	$(".progress-bullet-2 .progress-bullet").css("background","#05cab6");
$(".progress-line").css("width","35.70%");
...
$(".progress-line").css("width","42.84%");
		 ...
		 $('#add_applicant').prepend('<input type="hidden" data-exp="Yes" name="Job_Title[]" value="'+jobtitle_final_value+'" />');                
            ...
            if (emp_year_final_value == '') {
                if (emp_month_final_value != '') {
                    $(".emp-months-error").addClass("d-none");
                }
                $(".emp-years-error").removeClass("d-none");

            } else if (emp_month_final_value == '') {

                if (emp_year_final_value != '') {
                    $(".emp-years-error").addClass("d-none");
                }
                $(".emp-months-error").removeClass("d-none");
            } else {
	...
	if(total_time < 12){
        ...
        $(".step-6").removeClass("d-none");
         ...
         $(".progress-line").css("width","64.26%");
			 
		}
		else if (step_name == 'search-postcode-step') {
			$(".progress-line").css("width","71.4%");
                        	$(".progress-bullet-3 .progress-bullet").css("background","#05cab6");

		 var BuildingNumber = $("#BuildingNumber").val();
		 var BuildingName = $("#BuildingName").val();
		 var SubBuildingName = $("#SubBuildingName").val();
		 var street = $("#street").val();
		 var town = $("#town").val();
		 var county = $("#county").val();
		 var postcode = $("#postcode").val();
		 
		$(".mannual-postcode").removeClass("d-none"); 
		  
		 $('#add_applicant').prepend('<input type="hidden" name="Final_BuildingNumber[]" value="'+BuildingNumber+'" />');
		 $('#add_applicant').prepend('<input type="hidden" name="Final_BuildingName[]" value="'+BuildingName+'" />');
		 $('#add_applicant').prepend('<input type="hidden" name="Final_SubBuildingName[]" value="'+SubBuildingName+'" />');
		 $('#add_applicant').prepend('<input type="hidden" name="Final_street[]" value="'+street+'" />');
		 $('#add_applicant').prepend('<input type="hidden" name="Final_town[]" value="'+town+'" />'); 
		 $('#add_applicant').prepend('<input type="hidden" name="Final_county[]" value="'+county+'" />'); 
		 $('#add_applicant').prepend('<input type="hidden" name="Final_postcode[]" value="'+postcode+'" />'); 
		 $('#add_applicant').prepend('<input type="hidden"  id="Residential_Status" name="Residential_Status[]" value="Homeowner" />'); 
		  
		 $(".step-10").addClass("d-none");
         $(".step-11").removeClass("d-none");
			 
		}
		else if (step_name == 'residential-status-step') {
			$(".progress-line").css("width","78.54%");
			 $(".step-11").addClass("d-none");
         $(".step-12").removeClass("d-none");
		}
		else if (step_name == 'residential-time-step') {
			$(".progress-line").css("width","85.68%");
            var res_year_final_value = $("#residential-years").val();
            var res_month_final_value = $("#residential-months").val();
			var history =$('#pre-address-history').val();



            if (res_year_final_value == '') {
                if (res_month_final_value != '') {
                    $(".res-months-error").addClass("d-none");
                }
                $(".res-years-error").removeClass("d-none");

            } else if (res_month_final_value == '') {

                if (res_year_final_value != '') {
                    $(".res-years-error").addClass("d-none");
                }
                $(".res-months-error").removeClass("d-none");
            } else {
				
		var total_year=Number(res_year_final_value)*12;
		var total_time=Number(total_year)+Number(res_month_final_value)+Number(history);
         					
	if(total_time < 36){
		$('#pre-address-history').val(total_time);
		$('#residential-years').val('');	
		$('#residential-months').val('');	
	    $('#add_applicant').prepend('<input type="hidden"  name="Months_At_Address[]" value="'+res_month_final_value+'" />');
		$('#add_applicant').prepend('<input type="hidden"  name="Years_At_Address[]" value="'+res_year_final_value+'" />');
		  $(".residential-status-error").removeClass("d-none");
		
		$(".step-12").addClass("d-none");
        $(".step-10").removeClass("d-none");
		 ...
		 $('#add_applicant').prepend('<input type="hidden"  name="Months_At_Address[]" value="'+res_month_final_value+'" />');
		 $('#add_applicant').prepend('<input type="hidden"  name="Years_At_Address[]" value="'+res_year_final_value+'" />');
		 $('#add_applicant').prepend('<input type="hidden" id="Final_title" name="Final_title" value="Mr" />');
        
		$(".step-12").addClass("d-none");
         $(".step-13").removeClass("d-none");
		 ...
		 else if (step_name == 'almost-done-step') {
		 	$(".progress-line").css("width","98%");
		 	$(".progress-bullet-4 .progress-bullet").css("background","#05cab6");
            var forename_final_value = $("#Forename").val();
            var surname_final_value = $("#Surname").val();


            if (forename_final_value == '') {
                if (surname_final_value != '') {
                    $(".Surname-error").addClass("d-none");
                }
                $(".Forename-error").removeClass("d-none");

            } else if (surname_final_value == '') {

                if (forename_final_value != '') {
                    $(".Forename-error").addClass("d-none");
                }
                $(".Surname-error").removeClass("d-none");
            } else {

               
          $('#add_applicant').prepend('<input type="hidden"  name="Final-Forename" value="'+forename_final_value+'" />');
		 $('#add_applicant').prepend('<input type="hidden"  name="Final-Surname" value="'+surname_final_value+'" />');                
				
                $(".step-13").addClass("d-none");
                $(".step-14").removeClass("d-none");
            }
		 ...
		 else if (step_name == 'all-done-step') {
		 	
            var Email_final_value = $("#Email").val();
            var phone_final_value = $("#phone").val();


            if (Email_final_value == '') {
                if (phone_final_value != '') {
                    $(".phone-error").addClass("d-none");
                }
                $(".Email-error").removeClass("d-none");

            } else if (phone_final_value == '') {
          ...
          $('#add_applicant').prepend('<input type="hidden"  name="Final-Email" value="'+Email_final_value+'" />');
		  $('#add_applicant').prepend('<input type="hidden"  name="Final-phone" value="'+phone_final_value+'" />');                
		  $("#add_applicant").submit();
